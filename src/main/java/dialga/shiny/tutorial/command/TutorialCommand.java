...
public class TutorialCommand {
    ...
    public static void tutorial(final CommandContext args, CommandSender sender) throws Exception {
        ...
        elements.add(new ParticleElement       ("2s", Effect.HAPPY_VILLAGER, new Location(player.getWorld(), 939.5, 68, 135.5), new Vector(0,0,0), 1, 1, 1, 10, 30));
        elements.add(new RelativeTimeElement   ("4s", 1600L));
